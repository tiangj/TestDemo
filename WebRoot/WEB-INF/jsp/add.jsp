...
<div class="pageContent">
	<form action="report/save.do" method="post" class='required-validate pageForm'
		  onsubmit="return iframeCallback(this,navTabAjaxDone);">
		<input type="hidden" name="navTabId" value="page_Report">
		<input type="hidden" name="callbackType" value="closeCurrent">
		<input type="hidden" name="rel" value="page_Report">
